...
public class MinimizedCard extends AnchorPane {
    ...
    public MinimizedCard(String title, String value, String badgeValue, BadgeStyle badgeStyle){
        ...
        cardBadge.setMaxWidth(LayoutSizeManager.getResizedWidth(80));
        cardBadge.setPrefWidth(LayoutSizeManager.getResizedWidth(70));
        cardBadge.setMinWidth(LayoutSizeManager.getResizedWidth(70));
