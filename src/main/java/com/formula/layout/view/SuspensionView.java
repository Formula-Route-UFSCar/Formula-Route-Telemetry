...
@Getter
@Setter
public class SuspensionView extends Page {

    public SuspensionView(ApplicationWindow applicationWindow) {
    ...
    public void createView() {
        ...
        MinimizedCard testMinimizedCard = new MinimizedCard("Temperatura de Suspensão","23°C","+2.0%", BadgeStyle.DANGER);
